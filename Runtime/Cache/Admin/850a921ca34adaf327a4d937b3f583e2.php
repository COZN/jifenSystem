...
<html lang="zh-cn">
   <head>
      ...
      <link rel="stylesheet" href="/Tpl/Admin/css/daterangepicker/daterangepicker-bs3.css">
      <!--[if lt IE 9]>
   ...
   <body class='wst-page'>
     <form method='post' action='<?php echo U("Admin/LogLogins/index");?>'>
       ...
       <input type='text' id='key' name='key' value="<?php if($key){echo $key;}else{echo $startDate;} ?>"/>
