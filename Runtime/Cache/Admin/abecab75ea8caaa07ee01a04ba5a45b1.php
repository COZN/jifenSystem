...
<html lang="zh-cn">
   ...
   function edit(){
    ...
    /* params.id = $('#id').val();
     ...
     $.post("<?php echo U('Admin/LogIp/edit');?>",params,function(data,textStatus){
      var json = WST.toJson(data);
      if(json.status=='1'){
        Plugins.setWaitTipsMsg({ content:'操作成功',timeout:1000,callback:function(){
           location.href='<?php echo U("Admin/LogIp/index");?>';
        }});
      }else{
        Plugins.closeWindow();
   ...
   <body class="wst-page">
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           <tr>
             <th width='120' align='right'>允许登录的IP<font color='red'>*</font>：</th>
             <td>
                 <input type='text' name='ip' class="form-control wst-ipt" value='<?php echo ($object["ip"]); ?>' maxLength='25'/>
                 <span style="color:blue">*请输入有效的IP地址</span>
             </td>
           </tr>
           ...
           <tr>
             <td colspan='2' style='padding-left:250px;'>
                 <button type="submit" class="btn btn-success">保&nbsp;存</button>
                  <a class="btn btn-primary" href='<?php echo U("Admin/LogIp/index");?>'>返&nbsp;回</button>
             </td>
           </tr>
        </table>
       </form>
